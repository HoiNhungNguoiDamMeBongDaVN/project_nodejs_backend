...
var getBodyHTMLEmail = function getBodyHTMLEmail(dataSend) {
  ...
  if (dataSend.language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o ".concat(dataSend.patienName, "</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email th\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn web KhaHo</p>\n        <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh:</p>\n        <span>Th\u1EDDi gian:&emsp;<b>").concat(dataSend.time, "</b></span><br/>\n        <span>T\xEAn b\xE1c s\u0129 kh\xE1m:&emsp;<b>").concat(dataSend.nameDoctor, "</b></span>\n        <div><b ><i style=\"color:#737574\">N\u1EBFu th\xF4ng tin tr\xEAn l\xE0 \u0111\xFAng s\u1EF1 th\u1EADt, vui long click v\xE0o \u0111\u01B0\u1EDDng link n\xE0y \u0111\u1EC3 x\xE1c nh\u1EADn v\xE0 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh </i></b></div>\n        <a href=").concat(dataSend.redirectLink, " target=\"_blank\">Click here!</a>\n        <div><span>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</span></div>\n        ");
  } else {
    result = "\n        <h3>Hello ".concat(dataSend.patienName, "</h3>\n        <p>In case you have received the email, you have already scheduled an online medical appointment on the KhaHo website.</p>\n        <p>Medical Appointment Booking Information:</p>\n        <span>Time:&emsp;<b>").concat(dataSend.time, "</b></span><br/>\n        <span>Doctor's Name:&emsp;<b>").concat(dataSend.nameDoctor, "</b></span>\n        <div><b ><i style=\"color:#737574\">If the information above is true, please click on this link to confirm and complete the procedure for scheduling a medical appointment.</i></b></div>\n        <a href=").concat(dataSend.redirectLink, " target=\"_blank\">Click here!</a>\n        <div><span>Thank you sincerely!</span></div>\n        ");
  }
  return result;
};
var sendChangeAcccountPassword = /*#__PURE__*/function () {
  ...
  return function sendChangeAcccountPassword(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var getBodyHTMLEmailChangePassword = function getBodyHTMLEmailChangePassword(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o b\u1EA1n</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email th\xEC b\u1EA1n \u0111\xE3 nh\u1EA5n x\xE1c nh\u1EADn thay \u0111\u1ED5i password!</p>\n        <div><b ><i style=\"color:#737574\">N\u1EBFu b\u1EA1n th\u1EADt s\u1EF1 mu\u1ED1n thay \u0111\u1ED5i password, vui long click v\xE0o \u0111\u01B0\u1EDDng link n\xE0y \u0111\u1EC3 ho\xE0n th\xE0nh vi\u1EC7c thay \u0111\u1ED5i m\u1EADt kh\u1EA9u!</i></b></div>\n        <a href=".concat(dataSend.redirectLink, " target=\"_blank\">Click here!</a>\n        <div><span>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</span></div>\n        ");
  } else {
...
var changePasswordSubject = function changePasswordSubject(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
...
var sendAttachments = /*#__PURE__*/function () {
  ...
  return function sendAttachments(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
var changeSubject = function changeSubject(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o ".concat(dataSend.namePatient, "</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email th\xEC \u0111\xE3 kh\xE1m b\u1EC7nh th\xE0nh c\xF4ng !</p>\n        <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c:</p>\n        <div><b ><i style=\"color:#737574\">\u0110\u01A1n thu\u1ED1c c\u1EE7a b\u1EA1n \u0111\u01B0\u1EE3c g\u1EEDi \u1EDF file b\xEAn d\u01B0\u1EDBi.</i></b></div>\n        <div><span>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</span></div>\n        ");
  } else {
    result = "\n        <h3>Hello ".concat(dataSend.namePatient, "</h3>\n        <p>You have received the email, the medical examination was successful!</p>\n        <p>Prescription information:</p>\n        <div><b ><i style=\"color:#737574\">Your prescription is sent in the file below.</i></b></div>\n        <div><span>Thank you sincerely!</span></div>\n        ");
  }
  return result;
};
module.exports = {
