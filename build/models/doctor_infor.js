...
module.exports = function (sequelize, DataTypes) {
  var doctorinfor = /*#__PURE__*/function (_Model) {
    _inherits(doctorinfor, _Model);
    var _super = _createSuper(doctorinfor);
    function doctorinfor() {
      _classCallCheck(this, doctorinfor);
      return _super.apply(this, arguments);
    }
    _createClass(doctorinfor, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        ...
        doctorinfor.belongsTo(models.user, {
          ...
          targetKey: 'keyMap',
          as: 'payment'
        }), doctorinfor.hasOne(models.user, {
          foreignKey: 'id'
        });
      }
    }]);
